...
def GetListAsCsv(jsonResults):
    ...
    for item in ItemList:
        ...
        new_row = {'deviceName':a1,'jobName':a3,'jobType':a5,
        'startDateTime':a7,'endDateTime':a8,'jobExecutionStatus':b1,'progress':b2,'scheduleId':b3,'userId':b4,'deviceId':b5,'id':b6,
        'currentLine':b7,'totalLines':b8,'jobId':b9,'deploymentId':c5,
        'message':c9,'username':d3}
